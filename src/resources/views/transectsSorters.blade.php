<a href="#" class="list-group-item color-sort-list-group-item" title="Sort images by color" data-ng-controller="SortByColorController" data-ng-click="catchClick($event)">
